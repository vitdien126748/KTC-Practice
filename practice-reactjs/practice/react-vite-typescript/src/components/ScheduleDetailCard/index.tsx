...
const ScheduleDetailCard = ({title, subtitle}: TScheduleDetailCardProps) => {
  return (
    <div className={styles.card}>
        <div style={{display: 'flex', flexDirection: 'column', width: '100%',paddingLeft:8, gap: 3}}>
            <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%'}}>
                <span style={{fontWeight: 'bolder',fontSize: 16}}>{title}</span>
                <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center'}}><BsThreeDots /></span>
